 ...
 * @since 2020/5/18
 */
public class WaitTaskNodeModel extends BaseNodeModel {

    private ActionModel inAction;
    private ActionModel outAction;

    private WaitTaskNodeModel() {
    }

    public static WaitTaskNodeModel of() {
        return new WaitTaskNodeModel();
    }

    public static WaitTaskNodeModel getFromCellValue(Object cellValue) {
        return (WaitTaskNodeModel)cellValue;
    }
